...
- [laravel-interaction/rate](https://github.com/laravel-interaction/rate) - 😄 User rate/unrate behaviour for Laravel. (1 week ago)

#### 🌱 My latest projects

- [zingimmick/laravel-flysystem-oss](https://github.com/zingimmick/laravel-flysystem-oss) - OSS storage filesystem for Laravel
- [zingimmick/flysystem-oss](https://github.com/zingimmick/flysystem-oss) - Flysystem adapter for the OSS SDK
- [zingimmick/laravel-eloquent-relationships](https://github.com/zingimmick/laravel-eloquent-relationships) - More eloquent relationships for Laravel
- [zingimmick/laravel-scout-opensearch](https://github.com/zingimmick/laravel-scout-opensearch) - Laravel Scout custom engine for OpenSearch
- [zingimmick/rector-sample](https://github.com/zingimmick/rector-sample) - 
- [zingimmick/.github](https://github.com/zingimmick/.github) - Workflow templates for me
- [zingimmick/laravel-eloquent-extensions](https://github.com/zingimmick/laravel-eloquent-extensions) - Manage extensions for Laravel eloquent
- [zingimmick/laravel-flysystem-obs](https://github.com/zingimmick/laravel-flysystem-obs) - OBS storage filesystem for Laravel
- [zingimmick/flysystem-obs](https://github.com/zingimmick/flysystem-obs) - Flysystem adapter for the OBS SDK
- [zingimmick/ecs-sample](https://github.com/zingimmick/ecs-sample) - Sample repository for ECS.
...
- [计划表](https://gist.github.com/693b2373b6ecf9cc956c8135df2ce1e8) (4 years ago)
- [API对接文档](https://gist.github.com/8f834c3ba6fe7d5bbdab10ec0ebb2999) (4 years ago)
...
- [azl397985856/leetcode](https://github.com/azl397985856/leetcode) -  LeetCode Solutions: A Record of My Problem Solving Journey.( leetcode题解，记录自己的leetcode解题之路。) (1 month ago)
- [getActivity/EmojiPackage](https://github.com/getActivity/EmojiPackage) - 表情包资源合集，张张都是经典 (1 month ago)
- [cue-lang/cue](https://github.com/cue-lang/cue) - The new home of the CUE language! Validate and define text-based and dynamic configuration (1 month ago)
- [rocketeers/rocketeer](https://github.com/rocketeers/rocketeer) - Send your projects up in the clouds (1 month ago)
- [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) - Swagger Editor (1 month ago)
...
- [ImtiazVision](https://github.com/ImtiazVision)
- [ijagjeet](https://github.com/ijagjeet)
- [JacekAndrzejewski](https://github.com/JacekAndrzejewski)
- [undecane](https://github.com/undecane)
- [jlsjefferson](https://github.com/jlsjefferson)
